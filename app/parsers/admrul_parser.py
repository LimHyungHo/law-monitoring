    ...
    def _parse_ascii_table_to_html(self, content):
            ...
            if prefix_lines:
                ...
                for p in prefix_lines:
                    html.append(f"<p>{self._to_html_text(self.format_content(p))}</p>")
                html.append("</div>")
            ...
            if final_header:
                ...
                for col in final_header:
                    html.append(f"<th>{self._to_html_text(self.format_content(col))}</th>")
            ...
            for row in merged_body:
                html.append("<tr>")
                for col in row:
                    html.append(f"<td>{self._to_html_text(self.format_content(col))}</td>")
                html.append("</tr>")
